...
public class TestJsonEncodingUtils
{
            ...
            throws IOException
    {
        ...
        Page page = page(block);
        assertThat(roundTrip(sessionWithoutCapability(ClientCapabilities.VARIANT_JSON), columns, false, page, "[[null],[\"{\\\"a\\\":1,\\\"b\\\":[true,null]}\"],[\"null\"]]"))
                .isEqualTo(column(null, "{\"a\":1,\"b\":[true,null]}", "null"));
    }
            ...
            throws IOException
    {
        ...
        Page page = page(blockBuilder.build());
        assertThat(roundTrip(sessionWithoutCapability(ClientCapabilities.VARIANT_JSON), columns, false, page, "[[[1,\"{\\\"a\\\":1,\\\"nested\\\":[true,null]}\"]]]"))
            ...
            throws IOException
    {
        ...
        assertThat(roundTrip(
                sessionWithoutCapability(ClientCapabilities.VARIANT_JSON),
                columns,
                false,
                page,
